...
def xx_invalid_solution(board, solution):
    """ Function that checks if the solution given is solution to the
    problem."""
    ...
    return b != [[get_no_color() for col in line] for line in board]
